...
window.onload = function init(){ 
    ...
    //---------------------------------------------------
    var vertices = [ vec2(0.0, -Math.sqrt(2.0)/2.0), vec2(-Math.sqrt(2.0)/2.0, 0.0), vec2(Math.sqrt(2.0)/2.0, 0.0), vec2(0.0, Math.sqrt(2.0)/2.0) ];
     
    var theta = 0.0;
    var thetaLoc = gl.getUniformLocation(program, "theta"); //links uniform to the shaders
    //------------------------------------
